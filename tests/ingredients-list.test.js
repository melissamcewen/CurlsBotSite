...
test('analyze Keratin shampoo correctly', () => {
  ...
  var expected = {"alcohol": {"bad": [], "good": ["cetyl alcohol"], "unknown": []}, "other": {"bad": [], "good": [], "unknown": []}, "silicones": {"bad": [], "good": ["peg-12 dimethicone"], "unknown": []}, "sulfates": {"bad": [], "good": [], "unknown": []}, "wax": {"bad": [], "good": [], "unknown": []}};
...
test('analyze Tresemme Runway Waves correctly', () => {
  ...
  var expected = {"alcohol": {"bad": ["phenylpropanol"], "good": ["benzyl alcohol"], "unknown": []}, "other": {"bad": [], "good": [], "unknown": []}, "silicones": {"bad": [], "good": ["pegppg-2525 dimethicone", "peg-10 dimethicone"], "unknown": []}, "sulfates": {"bad": [], "good": [], "unknown": []}, "wax": {"bad": [], "good": [], "unknown": []}};
  var results = analyze(list);
...
test('analyze Ouidad Curl Recovery Meltdown correctly', () => {
  ...
  var expected = {"alcohol": {"bad": ["isopropyl alcohol"], "good": ["cetearyl alcohol", "cetyl alcohol"], "unknown": []}, "other": {"bad": [], "good": [], "unknown": []}, "silicones": {"bad": ["bis-hydroxymethoxy amodimethicone"], "good": [], "unknown": []}, "sulfates": {"bad": [], "good": [], "unknown": []}, "wax": {"bad": [], "good": [], "unknown": []}};
  var results = analyze(list);
  expect(analyze(list)).toEqual(expected);
  expect(detector(results)).toEqual("bad");
...
test('analyze Bounce Light Creme Gel correctly', () => {
  ...
  var expected = {"alcohol": {"bad": [], "good": ["aminomethyl propanol"], "unknown": []}, "other": {"bad": [], "good": [], "unknown": []}, "silicones": {"bad": [], "good": [], "unknown": []}, "sulfates": {"bad": [], "good": [], "unknown": []}, "wax": {"bad": [], "good": [], "unknown": []}};
  var results = analyze(list);
  expect(analyze(list)).toEqual(expected);
  expect(detector(results)).toEqual("good");
