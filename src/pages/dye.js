...
const dyePage = () => (
  <div>
    ...
    <p>Some CG specific henna tips</p>
    <ul>
    ...
    <p>Many CG folks swear by <a href="https://www.naturallycurly.com/curlreading/ingredients/olaplex-according-to-the-hair-pros">Olaplex</a> for restoring the hair after chemical dyes. Also para-phenylenediamine makes the hair more high porosity so you may want to switch to higher porosity products.</p>
