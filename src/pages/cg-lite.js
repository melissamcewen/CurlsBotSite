     ...
     <p>Some common <em>oily</em> product lines include:</p>
      ...
      <h2>Moptop $$$</h2>
        <ul>
          ...
          <li>Conditioner:
            <ReactGA.OutboundLink eventLabel="http://amzn.to/2ApLXiq" to="http://amzn.to/2ApLXiq" target="_blank"> Light Conditioner (contains very small amount of oil)* </ReactGA.OutboundLink></li>
          <li>Styler (curl enhancer) :  <ReactGA.OutboundLink eventLabel="http://amzn.to/2kNlZhU" to="http://amzn.to/2kNlZhU" target="_blank">Curly Hair Custard </ReactGA.OutboundLink></li>
          <li>Styler (hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2kK7lb3" to="http://amzn.to/2kK7lb3" target="_blank">Anti-frizz Medium Hold Gel </ReactGA.OutboundLink></li>
        </ul>

      <h2>Innersense $$$</h2>
      <ul>
        <li>Styler (hold): <ReactGA.OutboundLink eventLabel="http://amzn.to/2BYccc7" to="http://amzn.to/2BYccc7" target="_blank">I Create Hold</ReactGA.OutboundLink></li>
      ...
      <h2>Kinky Curly $$</h2>
        <ul>
          <li>Cleanser:  <ReactGA.OutboundLink eventLabel="http://amzn.to/2kLT3H0" to="http://amzn.to/2kLT3H0" target="_blank">Come Clean* - note this is one of the harsher shampoos on the list, use sparingly or just to clarify </ReactGA.OutboundLink></li>
      ...
      <h2>Not Your Mothers Naturals Blue Sea Kale & Pure Coconut Water Sea Minerals $</h2>
        <ul>
          <li>Cleanser:  <ReactGA.OutboundLink eventLabel="http://amzn.to/2B39QMf" to="http://amzn.to/2B39QMf" target="_blank">Shampoo </ReactGA.OutboundLink></li>
          <li>Conditioner:  <ReactGA.OutboundLink eventLabel="http://amzn.to/2kNBCpu" to="http://amzn.to/2kNBCpu" target="_blank">Conditioner </ReactGA.OutboundLink></li>
      ...
      <ul>
        ...
        <li>Styler (curl enhancer + hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2krQaL4" to="http://amzn.to/2krQaL4" target="_blank">Herbal Essences Totally Twisted Curl Boosting Hair Mousse </ReactGA.OutboundLink></li>
        <li>Styler (hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2zTIvbs" to="http://amzn.to/2zTIvbs" target="_blank">Aussie Instant Freeze Gel </ReactGA.OutboundLink></li>
      </ul>

      <h2>DIY Options</h2>
      <ul>
        <li>Conditioner/cleaner:  <ReactGA.OutboundLink eventLabel="https://blog.mountainroseherbs.com/diy-herbal-hair-rinses" to="https://blog.mountainroseherbs.com/diy-herbal-hair-rinses" target="_blank">Hair rinses* </ReactGA.OutboundLink>: my own personal fav is just marshmallow root pieces (1 tbsp) steeped in 1 cup of water overnight. </li>
        <li>Styler/conditioner (curl enhancer):  <ReactGA.OutboundLink eventLabel="http://www.minimalistbeauty.com/marshmallow-root-in-natural-hair-care/" to="http://www.minimalistbeauty.com/marshmallow-root-in-natural-hair-care/" target="_blank">Marshmallow root gel* </ReactGA.OutboundLink>- I sometimes add a dash of slippery elm (half teaspoon) while hot for extra frizz control</li>
        <li>Styler (curl enhancer  + light hold) :  <ReactGA.OutboundLink eventLabel="http://www.minimalistbeauty.com/diy-natural-hair-gel/" to="http://www.minimalistbeauty.com/diy-natural-hair-gel/" target="_blank">Flax seed gel* </ReactGA.OutboundLink></li>
      </ul>
      ...
      <h2>Giovanni $</h2>
        <ul>
          ...
          <li>Styler (curl enhancer + hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2yiPOYH" to="http://amzn.to/2yiPOYH" target="_blank">Hair Styling Mousse </ReactGA.OutboundLink></li>
          <li>Styler (hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2AwkkEe" to="http://amzn.to/2AwkkEe" target="_blank">LA Natural Gel </ReactGA.OutboundLink></li>
        ...
        <h2>Jessicurl $$</h2>
        <ul>
          <li>Conditioner:  <ReactGA.OutboundLink eventLabel="http://amzn.to/2jn4OzU" to="http://amzn.to/2jn4OzU" target="_blank">Aloeba Daily Conditioner* </ReactGA.OutboundLink></li>
          <li><ReactGA.OutboundLink eventLabel="http://amzn.to/2kMUHbe" to="http://amzn.to/2kMUHbe" target="_blank">Styler (curl enhancer) : Rockin' Ringlets Styling Potion*</ReactGA.OutboundLink></li>
          <li>Styler: <ReactGA.OutboundLink eventLabel="http://amzn.to/2Aotpip" to="http://amzn.to/2Aotpip" target="_blank">Styler (hold) : Spiralicious Styling Gel*</ReactGA.OutboundLink></li>
        </ul>
      ...
      <ul>
        ...
        <li>Styler (mild curl enhancer) :  <ReactGA.OutboundLink eventLabel="http://amzn.to/2AdXxJd" to="http://amzn.to/2AdXxJd" target="_blank">Combing Cream* </ReactGA.OutboundLink> - use as a cream without combing</li>
        <li>Styler (mild hold):  <ReactGA.OutboundLink eventLabel="http://amzn.to/2AOWuR2" to="http://amzn.to/2AOWuR2" target="_blank">Detangler* </ReactGA.OutboundLink>- use in very small amounts as a gel-like product or refresher</li>
