...
const Works = () => (
  <div>
    ...
    <h2>How do I send Curlsbot lists of ingredients?</h2>
    ...
    <h2>What list do you use?</h2>
    <p><Link to="/curly-girl-ingredient-list/" >Click here to see our complete list.</Link></p>

    <h2>Why does Curlsbot give me the wrong results?</h2>
    <p>Curlsbot is not perfect, Curlsbot will give the wrong results if ingredients are misspelled: I recommend you find a list from the manufacturer's or a store website rather than typing the list out yourself. Occasionally these lists also have misspellings. </p>

     <h2>Why can't Curlsbot read my list?</h2>
      ...
      <h2>Can you tell me if this picture is Curly Girl approved?</h2>
      ...
      <h2>What does it mean if it says "Caution"?</h2>
      ...
      <h2>Can Curlsbot read other languages besides English?</h2>
