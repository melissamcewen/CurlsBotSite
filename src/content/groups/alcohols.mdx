...
Alcohols are a diverse group but the two main scientific categories in haircare products are<InlineReference id="1" />:
...
[The cosmetic chemists at Beauty Brains](https://thebeautybrains.com/2014/04/why-is-there-isopropyl-alcohol-in-my-conditioner/)<InlineReference id="2" /> note that in the case of a conditioner with isopropyl alcohol, it's part of the manufacturing process and only present in small amounts. Short-chain alcohols are useful as solvents, which means they help dissolve other ingredients<InlineReference id="3" />.

Lorraine Massey recommends avoiding short-chain alcohols in gels in [Curly Girl: The Handbook](https://amzn.to/40b2Jfr)<InlineReference id="6" />.
...
- Short-chain alcohols = volatile alcohols
- Long-chain alcohols = emollient alcohols

But of course as you read above, it's a lot more complicated than that! We recommend some products that have these so-called "volatile alcohols" if it's in small amounts or in a product that is not meant to stay on hair
