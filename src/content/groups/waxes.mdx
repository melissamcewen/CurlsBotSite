...
The barrier it creates can trap moisture and heat, promoting fungal (Malassezia) growth that's linked to conditions like seborraic dematitis<InlineReference id="24" />.
...
Lorraine Massey's [Curly Girl: The Handbook](https://amzn.to/40b2Jfr)<InlineReference id="6" />  has a section written by Vida Vladirm that mentions the negative effects of wax
