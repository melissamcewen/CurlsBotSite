...
Walker's system has  4 types: straight (1), wavy (2), curly (3), and kinky (4). Within those types there were subcategories for different patterns from a-c. Originally only types 1 and 2 had a-c, with 3 and 4 only having a and b, but these days many charts have a-c for all types.

Many charts inspired by Walker also use a-c to denote relative curliness when Walker had them signify strand thickness (from fine to coarse) but only for types 1 and 2. Only type 3 used a to denote looser curls and b to denote tighter. Once you got to 4, a meant coils and b meant kinks. Confusing huh?

It's a system that is still very popular but has received criticism for oversimplifying the diversity in types 3-4 and reinforcing hierarchies that focus on 3 being the desired type.
...
## The CurlsBot Curl Typing System
Based on all this research, especially the work from Gaines, Lasisi, and Irizarry, I ended up building my [own curl typing system for CurlsBot](/hair-types). It:

- Treats waves, curls, and coils as a spectrum of coils rather than totally different species
- Uses shrinkage and how your hair behaves with water as a main dividing line
- Leaves truly straight hair out of the system, since it behaves differently and likely comes from distinct genetic variants
- Is designed around what actually changes your routine, not how close your hair matches a picture on a chart

Instead of asking you to squint at diagrams, it’s built around a quiz.

[If you want to know your hair type, take the CurlsBot curl typing quiz here](/hair-types/quiz)
...
For the CurlsBot typing system, I made a quiz that you can take [here](/hair-types/quiz) to find out your hair type easily.
...
In straighter hair, dry styling is less damaging than wet styling, but in curlier hair it's the opposite. The wetting decreases curvature, which decreases resistance to forces like combing <InlineReference id="71" />. There is also research suggesting that very tightly curled/coily/kinky hair might be STRONGER when wet, unlike all the other hair types <InlineReference id="148" />.
...
Since I have the infamous ["Irish curls"](/blog/irish-curls-explained) (mixed loose curls,waves, and straight sections) I sometimes use a boar bristle brush on stringy straight/lightly wavy sections but I avoid using it on curly sections.
...
[Wavy and straight hair](/hair-types) retains moisture longer, likely due to larger, more widely spaced cuticle layers that allow for smoother moisture retention.
...
### Tightly curled/coily/kinky hair has a unique relationship with water
Some of the most intriguing research on hair science is being done
...
### Tightly curled/coily/kinky hair has a unique relationship with water
Some of the most intriguing research on hair science is being done in South Africa. Recently a team there discovered something intriguing: tightly curled/coiled hair has a unique relationship with water <InlineReference id="148" />.

Their data suggests something stunning: the curliest hair types may be STRONGER when wet. That's because of unique "type 2" hydrogen bonds in between the strands of hair. These bonds can also repel water, which is likely why this hair type gets labeled as "low porosity" even though the issue isn’t a sealed cuticle at all. 
