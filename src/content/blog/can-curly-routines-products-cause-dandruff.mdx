...
Updated August 7, 2025: We now have a [Malassezia analyzer](/labs/sebderm) that can check if your products are free from ingredients that feed Malassezia, I also added more info on ingredients that feed Malassezia.
...
Products can also contribute to scalp buildup, especially those with fatty ingredients like oils and butters, which may feed Malassezia. Keep in mind that these will be more problematic if they are in leave-in products, which stay on the scalp, vs rinse-off products like most shampoos and conditioners. However, if you're very sensitive, it might be worth avoiding these ingredients in all products. We have a list of [safe products for seborrheic dermatitis](/best/best-sebderm-safe-products) that you can check out and you can put any ingredient list in our [Malassezia analyzer](/labs/sebderm) to see if it's safe for seborrheic dermatitis.
...
Researchers have also found indications that Malassezia can metabolize fatty acids, which are components of oils and butters, and sometimes used by themselves <InlineReference id="129" />.
...
#### Other ingredients that feed Malassezia

It's not just oils that feed Malassezia.

- [Esters](/categories/esters) and Polysorbates: These are combinations of fatty acids and alcohols, which can be broken down into fatty acids, which as we've noted above, can feed Malassezia. <InlineReference id="130" />
- [Emollient alcohols](/categories/emollient-alcohols): These are alcohols that are derived from fatty acids and there is some evidence that they can feed Malassezia. Our [Malassezia analyzer](/labs/sebderm) checks for Cetearyl Alcohol and Emulsifying Wax, which are the ones most strongly linked to Malassezia. <InlineReference id="86" />
- Amino acids: Some amino acids have been shown to feed Malassezia, especially in the presence of other lipids (fatty ingredients) <InlineReference id="131" />
...
Malassezia seems to thrive at higher (more basic) pH levels<InlineReference id="132" />. There is no evidence that products can alter this significantly. But if you're looking for more acidic (less basic) products, you can check out our [Curl Friendly Low-pH Shampoos](/blog/curl-friendly-low-ph-shampoos-cowashes) blog post.
...
If you don’t have access to a well-formulated prescription shampoo, you may be stuck using an OTC or prescription option that’s too drying for [curly, coily or wavy hair](/hair-types).
...
<BlogProduct
  ...
  sulfateFree
  cgmApproved
  amazonLink="https://amzn.to/4aWHsdw"
  sample={true}
/>
...
1. Wash your hair at least once a week—use a pre-poo to protect your ends if needed, wash more often in warm, humid conditions
...
The biggest takeaway for me is that keeping my scalp free of buildup is essential to preventing dandruff. Avoiding oils on my scalp has helped me stay sebderm-free for the past few years, though it took adding the exfoliating treatments to be 100% dandruff free. Malassezia seems to thrive in warm, humid conditions <InlineReference id="132" />. This is why it's more common in the summer, when humidity is higher. Personally I have to wash my hair every other day in the summer to avoid dandruff.

I hope this guide helps you find what works for your hair and scalp, too.
