...
In [CurlsBot's type system](/hair-types), there are two types of curls: tight and loose. Loose is more closely related to wavy hair, and they both need pretty similar routines, the only divide is that loose curls are MOSTLY curls and wavy hair is MOSTLY waves, but they are usually a mix of both. Tight curls are in a different family and are more closely related to coils.
