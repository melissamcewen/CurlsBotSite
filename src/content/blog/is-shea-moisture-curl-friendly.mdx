...
A common topic in curly hair forums is product "weight" (how many emollients like oils and butters are in the product), particularly for those with [low porosity hair](/porosity/low-porosity):

### Why "Weight" Matters

Products that are too heavy for one's hair type can:
* Weigh down curls
* Cause buildup
...
* Rich [oils](https://www.curlsbot.com/groups/oils) (coconut oil, castor oil)
* Multiple moisturizing ingredients like [fatty alcohols](https://www.curlsbot.com/categories/emollient-alcohols)
...
* [High porosity hair](/porosity/high-porosity)
...
2. **Application Tips for Lighter Results**:
   ...
   * Dilute products with water (emulsify in your hands with warm water in the shower)
...
2. **Other Brands to Consider**:
   * [Jessicurl](https://sovrn.co/whrbixm)
   * Giovanni
   * Kinky-Curly
   * Not Your Mother's Naturals

3. **[Product Types to Look For](https://www.curlsbot.com/products)**:
