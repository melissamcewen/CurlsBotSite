...
You can check a product on CurlsBot's [ingredient analyzer](/cgm-analyzer). If the summary says "Lightweight product" it is likely more appropriate for loose curls and waves.
