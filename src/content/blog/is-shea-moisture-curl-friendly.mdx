...
The main problem with Shea Moisture is that most of their products are formulated for [tight curls/coils](/hair-types/) that are not weighed down by ingredients like [oils](hgroups/oils) and butters.
