...
It also does contain a [drying alcohol](/categories/drying-alcohols) but it’s pretty far down the ingredients list and alcohol is really only a worry in leave-in products and only if they are hair that stays wet.
...
<BlogProduct
  ...
  image="/images/blog/curl-friendly-low-ph-shampoos-cowashes/tootilab.jpeg"
...
It contains a small amount of isopropyl alcohol, which is considered a ["drying alcohol"](/categories/drying-alcohols) by some, but as it is washed out, we do not believe it’s a concern.
