      ...
      <div className="result">
       ...
       <h3> Your hair is: <strong>{props.quizResult}</strong></h3>
        ...
        <ul>
          ...
          <li>High porosity recommendations (coming soon!): If you are high porosity, your hair benefits from a lot of nourishment and moisture. Use rich creamy products to help give your hair shine and lock in moisture. Your hair is vulnerable to damage (or is damaged) so handle with care. Swap your shampoo for a gentle co-wash (a cleansing conditioner). </li>
          <li>Normal porosity recommendations (coming soon!): If you have normal porosity your hair is healthy and easy to work with. Products that are balanced with moisture can help your hair remain healthy. You may want to alternate co-wash and low-poo for balance.</li>
        </ul>
      </div>
    );
  }
