...
export default function Navbar() {
  ...
  return (
    <header className="w-full contain-content">
      <nav className="navbar bg-accent text-accent-content backdrop-blur-sm sticky top-0 z-50 contain-intrinsic-size-[50px]">
