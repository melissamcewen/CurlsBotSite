...
export default function Sidebar() {
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row md:flex-col p-2">
      <div className="card card-sm border-primary border-2 bg-base-100">
        <div className="card-body ">
          ...
          <div className="space-y-2">
            <div className="flex gap-2">
              <FileText className="w-5 h-5 shrink-0 mt-1" />
              <p>
            ...
            <div className="flex gap-2">
              <FlaskConical className="w-5 h-5 shrink-0 mt-1" />
              <p>
                For example,{' '}
            ...
            <div className="flex gap-2">
              <ShoppingBag className="w-5 h-5 shrink-0 mt-1" />
