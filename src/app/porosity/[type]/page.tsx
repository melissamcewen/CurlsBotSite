...
const POROSITY_DATA: Record<string, PorosityInfo> = {
  'low-porosity': {
    ...
    description: 'Low porosity hair has a tightly bound cuticle layer, making it difficult for moisture to penetrate the hair shaft. This type of hair is often resistant to treatments and can be prone to product buildup.',
    characteristics: [
  ...
  'high-porosity': {
    ...
    description: 'High porosity hair has a raised or damaged cuticle layer, allowing moisture to easily enter and exit the hair shaft. This type of hair can become easily moisturized but also loses moisture quickly.',
    characteristics: [
  ...
  'normal-porosity': {
    ...
    description: 'Normal porosity hair has a healthy cuticle layer that allows for balanced moisture absorption and retention. This type of hair is generally easier to maintain and style.',
    characteristics: [
...
export default function PorosityPage({ params }: Props) {
