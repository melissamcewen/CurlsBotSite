...
export const metadata: Metadata = {
  ...
  description: 'Privacy policy and data handling practices for CurlsBot',
};
      ...
      <div className="card bg-base-100 rounded-xl">
        <div className="card-body">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2>Overview</h2>
            <p>
              CurlsBot is committed to protecting your privacy. This policy explains how we handle your data
              when you use our ingredient analysis tools and website features.
            </p>

            <h2>Information We Collect</h2>
            <h3>Ingredient Lists</h3>
            <p>
              When you use our ingredient analyzer, we process the ingredient lists you provide. This processing
              happens entirely in your browser - we don&apos;t store or transmit your ingredient lists to any server.
            </p>
            ...
            <p>
              If you contact us through our contact form, we collect the information you provide (such as your
            ...
            <p>
              Our product recommendations include affiliate links (primarily Amazon Associates). When you click
              these links, we may earn a commission from qualifying purchases. This doesn&apos;t affect the price
              you pay.
            </p>
