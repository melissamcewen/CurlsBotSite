          ...
          <article className="max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-base-100 cb-card-lite md:col-span-2">
                ...
                <p className="mb-4">
                  Your hair dries perfectly straight naturally. While straight hair
                  isn&apos;t part of our pattern-based system, there are still
                  other factors that affect your hair care.
                </p>
                <p className="text-sm opacity-80">
                  <strong>Typical behaviors:</strong> No natural bends, waves, or
                  curls; dries completely straight without products or tools
                </p>
              </div>
        ...
        <article className="max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-base-100 cb-card-lite md:col-span-2">
              ...
              <p className="text-sm opacity-80">
                <strong>Typical behaviors:</strong> {patternData.typicalBehaviors}
              </p>
            </div>
            ...
            <div className="bg-base-100 cb-card-lite">
              <h3 className="font-semibold mb-2">Common/Social System</h3>
            ...
            <div className="bg-base-100 cb-card-lite md:col-span-2">
              ...
              <div className="space-y-3 text-sm">
                <p>
                  Your hair naturally forms a {patternData.displayName.toLowerCase()}{' '}
                  pattern. This means your hair{' '}
                  {patternData.typicalBehaviors.toLowerCase()}. Understanding this
                  pattern helps you choose products and techniques that work with
                  your hair&apos;s natural behavior.
                </p>
                <p>
                  Shrinkage of {patternData.shrinkage} indicates how much your hair
                  contracts when it dries, which affects length retention and styling
                  approaches.
                </p>
            ...
            <div className="bg-base-100 cb-card-lite md:col-span-2">
              <h2 className="font-bold text-xl mb-4">Product Recommendations</h2>
              <p className="text-sm opacity-60 italic mb-4">
                Product recommendations will be added here. These will include
                affiliate-linked products specifically suited for {patternData.displayName.toLowerCase()}{' '}
                hair patterns.
              </p>
            </div>
          </div>
